...
export const englishDirectoryDescriptions: Record<NodeId, string> = {
  ...
  lab:
    "Interface experiments, reader prototypes, and performance drafts gather on this side, with a stronger workbench tone.",
  playground:
  ...
  "archive-essays":
    "More complete essays and series drafts designed for sustained reading.",
  "archive-notes":
    "Shorter notes that help validate lightweight articles and concise summaries.",
