# SysFolio 视觉 Token v1

## 1. 使用说明

这份文档用于把 `filesystem-reading-page-v1.md` 里的视觉方向收敛成可实现的设计 token。
...
v1 默认采用浅色为主、深色同步支持的双主题方案，基于现有 `Work Context Day`、`Work Context Care`、`Work Context Night` 与 `Work Context Focus` 主题收敛而成。
